...
candidate_database = {
    "Lane": ["Lane", "0xa7AB8345B3e38B87d6F295f4d94fCDD64c46309f", "4.3", .20, "lane.jpeg"],
    "Ash": ["Ash", "0x69DF8034eb9fA0a75Ae29e1f2100137ad5d4f9A8", "5.0", .33, "ash.jpeg"],
    "Jo": ["Jo", "0xB5A2EaeC09D82700Bd6e00F281AE84D87a6a668e", "4.7", .19, "jo.jpeg"],
    "Kendall": ["Kendall", "0xFc86F8Cc0097e90Cfc8b0845FfD6deaAaEE3D32a", "4.1", .16, "kendall.jpeg"]
}
...
st.write(get_balance(w3, account.address))
